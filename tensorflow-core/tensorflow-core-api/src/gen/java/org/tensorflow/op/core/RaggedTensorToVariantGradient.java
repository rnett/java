...
public final class RaggedTensorToVariantGradient<U extends TType> extends RawOp implements Operand<U> {
  ...
  public static <U extends TType, T extends TNumber> RaggedTensorToVariantGradient<U> create(Scope scope, Operand<?> encodedRaggedGrad, Operand<T> rowSplits, Operand<TInt32> denseValuesShape, DataType<U> Tvalues) {
