...
public final class IgnoreErrorsDataset extends RawOp implements Operand<TType> {
  ...
  public static IgnoreErrorsDataset create(Scope scope, Operand<?> inputDataset, List<DataType<?>> outputTypes, List<Shape> outputShapes, Options... options) {
  ...
  public static final String OP_NAME = "IgnoreErrorsDataset";
