...
public final class StatelessRandomUniformFullIntV2<U extends TNumber> extends RawOp implements Operand<U> {
  ...
  public static <U extends TNumber, T extends TNumber> StatelessRandomUniformFullIntV2<U> create(Scope scope, Operand<T> shape, Operand<?> key, Operand<?> counter, Operand<TInt32> alg, DataType<U> dtype) {
    ...
    return new StatelessRandomUniformFullIntV2<U>(opBuilder.build());
  }
