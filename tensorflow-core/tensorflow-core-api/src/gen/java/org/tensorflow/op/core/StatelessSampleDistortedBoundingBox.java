...
public final class StatelessSampleDistortedBoundingBox<T extends TNumber> extends RawOp {
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.core.StatelessSampleDistortedBoundingBox}
   */
  ...
  public static <T extends TNumber, U extends TNumber> StatelessSampleDistortedBoundingBox<T> create(Scope scope, Operand<T> imageSize, Operand<TFloat32> boundingBoxes, Operand<TFloat32> minObjectCovered, Operand<U> seed, Options... options) {
