...
public final class RebatchDatasetV2 extends RawOp implements Operand<TType> {
  ...
  public static RebatchDatasetV2 create(Scope scope, Operand<?> inputDataset, Operand<TInt64> batchSizes, Operand<TBool> dropRemainder, List<DataType<?>> outputTypes, List<Shape> outputShapes) {
