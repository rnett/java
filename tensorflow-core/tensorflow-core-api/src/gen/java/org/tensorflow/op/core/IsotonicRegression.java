...
public final class IsotonicRegression<U extends TNumber> extends RawOp {
  ...
  public static <U extends TNumber, T extends TNumber> IsotonicRegression<U> create(Scope scope, Operand<T> input, DataType<U> outputDtype) {
   ...
   */
  @Endpoint(describeByClass = true)
  public static <T extends TNumber> IsotonicRegression<TFloat32> create(Scope scope, Operand<T> input) {
