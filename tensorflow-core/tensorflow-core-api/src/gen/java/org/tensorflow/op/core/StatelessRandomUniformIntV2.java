...
public final class StatelessRandomUniformIntV2<U extends TNumber> extends RawOp implements Operand<U> {
  ...
  public static <U extends TNumber, T extends TNumber> StatelessRandomUniformIntV2<U> create(Scope scope, Operand<T> shape, Operand<?> key, Operand<?> counter, Operand<TInt32> alg, Operand<U> minval, Operand<U> maxval) {
