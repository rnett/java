...
public final class XlaRecvFromHost<T extends TType> extends RawOp implements Operand<T> {
  ...
  public static <T extends TType> XlaRecvFromHost<T> create(Scope scope, DataType<T> Toutput, Shape shape, String key) {
    ...
    return new XlaRecvFromHost<T>(opBuilder.build());
  }
