 ...
 */
public final class CollectiveGatherV2<T extends TNumber> extends RawOp implements Operand<T> {
  
  /**
   * Optional attributes for {@link org.tensorflow.op.core.CollectiveGatherV2}
   */
   ...
   * @return a new instance of CollectiveGatherV2
   */
  @Endpoint(describeByClass = true)
  public static <T extends TNumber> CollectiveGatherV2<T> create(Scope scope, Operand<T> input, Operand<TInt32> groupSize, Operand<TInt32> groupKey, Operand<TInt32> instanceKey, Options... options) {
    OperationBuilder opBuilder = scope.env().opBuilder("CollectiveGatherV2", scope.makeOpName("CollectiveGatherV2"));
    ...
    return new CollectiveGatherV2<T>(opBuilder.build());
  }
  ...
  private CollectiveGatherV2(Operation operation) {
    super(operation);
    int outputIdx = 0;
