 ...
 */
public final class CollectiveReduceV2<T extends TNumber> extends RawOp implements Operand<T> {
  
  /**
   * Optional attributes for {@link org.tensorflow.op.core.CollectiveReduceV2}
   */
   ...
   * @return a new instance of CollectiveReduceV2
   */
  @Endpoint(describeByClass = true)
  public static <T extends TNumber> CollectiveReduceV2<T> create(Scope scope, Operand<T> input, Operand<TInt32> groupSize, Operand<TInt32> groupKey, Operand<TInt32> instanceKey, String mergeOp, String finalOp, Options... options) {
    OperationBuilder opBuilder = scope.env().opBuilder("CollectiveReduceV2", scope.makeOpName("CollectiveReduceV2"));
    ...
    return new CollectiveReduceV2<T>(opBuilder.build());
  }
  ...
  private CollectiveReduceV2(Operation operation) {
    super(operation);
    int outputIdx = 0;
