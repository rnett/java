...
// Parsed from tensorflow/c/c_api.cc

// Helper functions -----------------------------------------------------------

public static native TF_Operation ToOperation(Node node);

public static native @StdString BytePointer OutputName(@Const @ByRef TF_Output output);

// #if !defined(IS_MOBILE_PLATFORM) && !defined(IS_SLIM_BUILD)
public static native @ByVal NativeOutputVector OutputsFromTFOutputs(TF_Output tf_outputs,
                                                     int n);

public static native void TFOutputsFromOutputs(@Const @ByRef NativeOutputVector outputs,
